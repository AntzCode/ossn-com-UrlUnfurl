...
class UrlUnfurl
{
	...
	public function __construct(){
		...
		(new \OssnComponents())->setSettings('UrlUnfurl', ['image_width' => 700]);
		(new \OssnComponents())->setSettings('UrlUnfurl', ['image_height' => 350]);
		(new \OssnComponents())->setSettings('UrlUnfurl', ['image_min_width' => 395]);
		(new \OssnComponents())->setSettings('UrlUnfurl', ['image_min_height' => 235]);
